...
export default function Register() {
  ...
  let mySchema = Yup.object({
    name: Yup.string()
      ...
      .max(15, "Max letters is 15"),
    email: Yup.string().required("Required").email("Invalid Email"),
    password: Yup.string()
      .matches(
        /^[A-Z][a-z0-9]{3,8}$/,
        "Keep your password secure! Use a combination of uppercase and lowercase letters, numbers, and special characters to make it more secure"
      )
      .required("Required"),
    rePassword: Yup.string()
      .required("Required")
      .oneOf([Yup.ref("password")], "RePasword must be Match"),
    phone: Yup.string()
      .required("Required")
              ...
              <form onSubmit={formik.handleSubmit}>
                <div className={`${styles.formBox} bg-nav-color`}>
                  <div className={`${styles.form}`}>
                    ...
                    {isLoading ? (
                      <div className={`${styles.spinner} m-auto `}></div>
                    ) : (
